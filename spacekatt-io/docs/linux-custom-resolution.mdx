...
For instance, GDM3 is GNOME's display manager and manages the login screen, authentication, and user sessions.
...
[VESA BIOS Extentions](https://en.wikipedia.org/wiki/VESA_BIOS_Extensions#Linux_video_mode_numbers) (VBE) provides the kernel to set the VESA mode at boot.
